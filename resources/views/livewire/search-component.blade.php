                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="pagelimit">
                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.details',['uuid' => $product->uuid]) }}" title="{{ $product->name }}">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a href="#" class="btn add-to-cart" wire:click.prevent="store('{{$product->uuid}}','{{ $product->name}}',{{ $product->price }})">Add To Cart</a>
                                    </div>
                                </div>
                            </li>
                        @endforeach
