						...
						@foreach(Cart::content() as $item)
							<li class="pr-cart-item">
								<div class="product-image">
									<figure><img src="{{ asset('assets/images/products') }}/{{ $item->associatedModel::where('uuid',$item->id)->first()->image }}" alt="{{ $item->name }}"></figure>
								</div>
								<div class="product-name">
									<a class="link-to-product" href="{{ route('product.details',['uuid' => $item->id]) }}">{{ $item->name }}</a>
								</div>
